    ...
    <div class="dashboard-content-one">
        ...
        <div class="breadcrumbs-area">
            ...
            <ul>
                ...
                <li>{{ isset($chool) ? 'Modifier' : 'Nouveau' }} Ecole</li>
            </ul>
        </div>
            ...
            <div class="card-body">
                <div class="heading-layout1">
                    <div class="item-title">
                        <h3>{{ isset($chool) ? 'Modifier' : 'Ajouter' }} Ecole</h3>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 form-group mg-t-30">
                            ...
                            @if(isset($school) && $school->logo)
                                <p>Logo actuel : <img src="{{ asset('storage/' . $school->logo) }}" alt="{{ $school->name }}" style="max-width: 100px;"></p>
                            @endif
                        </div>
