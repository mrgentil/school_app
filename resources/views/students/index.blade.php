                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            @endcan
                                                <a href="{{ route('students.history', $student) }}"
                                                   class="btn-fill-sm bg-gradient-orange text-white mr-2"
                                                   title="Historique">
                                                    <i class="fas fa-history"></i>
                                                </a>
                                            @can('viewHistory', $student)
                                                <a class="dropdown-item" href="{{ route('students.history', $student) }}">
                                                    <i class="fas fa-history text-info"></i> Historique
                                                </a>
                                            @endcan
