...
@section('title', isset($user) ? 'Modifier un utilisateur' : 'Ajouter un utilisateur')

@section('meta_description')
    {{ isset($user) ? "Modification des informations de l'utilisateur {$user->name}" : "Formulaire d'ajout d'un nouvel utilisateur" }}
@endsection
@section('content')
